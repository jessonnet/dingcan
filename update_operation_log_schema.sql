-- 更新操作日志表结构
-- 备份现有数据
CREATE TABLE IF NOT EXISTS `operation_log_backup` LIKE `operation_log`;
INSERT INTO `operation_log_backup` SELECT * FROM `operation_log`;
...
-- SELECT user_id, operation_type, operation_content, operation_time, ip_address FROM `operation_log_backup`;
